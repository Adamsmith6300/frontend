...
// CONCATENATED MODULE: ./store/middleware.js
...
/* harmony default export */ var store_middleware = ([...middleware, ...imports]);
...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actions["a" /* default */].ERROR_SUBMIT_FORM_DATA:
      return _objectSpread(_objectSpread({}, state), {}, {
        formError: action.payload
      });

    case actions["a" /* default */].SIGNUP_SUCCESS:
      return _objectSpread(_objectSpread({}, state), {}, {
        successfulSignup: true
      });

    case actions["a" /* default */].LOGIN_SUCCESS:
      return _objectSpread(_objectSpread({}, state), {}, {
        successfulLogin: true
      });

    case actions["a" /* default */].VERIFY_SUCCESS:
      return _objectSpread(_objectSpread({}, state), {}, {
        verifiedUser: true
      });
...
const makeStore = context => Object(external_redux_["createStore"])(reducer, Object(external_redux_["compose"])(Object(external_redux_["applyMiddleware"])(external_redux_thunk_default.a, ...store_middleware))); // export an assembled wrapper
...
class _app_MyApp extends app_default.a {
  constructor(...args) {
    ...
    _app_defineProperty(this, "getInitialProps", async ({
      Component,
      ctx
    }) => {
      // ctx.store.dispatch({ type: "TOE", payload: "was set in _app" });
      return {
        pageProps: _app_objectSpread(_app_objectSpread({}, Component.getInitialProps ? await Component.getInitialProps(ctx) : {}), {}, {
